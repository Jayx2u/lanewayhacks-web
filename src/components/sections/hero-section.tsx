...
export default function HeroSection() {
  return (
    <div className="h-screen w-full bg-[#281c30] relative flex flex-col items-end justify-start antialiased p-8 md:p-12 text-unbounded overflow-hidden">
        <motion.div
        ...
        <motion.div
          ...
          className="absolute right-4 top-0 h-full flex items-center justify-center writing-mode-vertical z-20"
        >
          <VerticalScroll />
        </motion.div>
        <BackgroundBeams />
