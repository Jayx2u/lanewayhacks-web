  ...
  return (
    <div className="h-screen w-full bg-[#281c30] relative flex flex-col items-end justify-start antialiased p-12 text-unbounded">
      ...
      <div className="relative z-10 text-right pr-8">
        <hr className="border-t-2 border-[#C5B5D9] pr-20 my-4" />
        <p className="text-[#D9D5EE] max-w-2xl my-2 text-lg md:text-xl text-right pl-4 font-unbounded">
        ...
        <div className="flex justify-end font-unbounded">
          <EmailSignup />
        </div>
      </div>

      {/* Bottom Left Text */}
      <div className="absolute bottom-8 left-8 flex flex-col z-10 font-unbounded">
        <div className="text-[#B791FF] text-6xl md:text-8xl font-bold flex items-center gap-2">
          <span>Q3 2025</span> <PiStarFourFill />
        </div>
        <div className="text-[#D9D5EE] text-xl md:text-2xl font-medium mt-2">
